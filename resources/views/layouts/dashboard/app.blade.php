				...
				<div id="kt_aside" class="aside aside-light aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-logo flex-column-auto" id="kt_aside_logo">
						...
						<a href="{{ route('dashboard') }}">
							<img alt="Logo" src="{{asset('assets/pipper/logo-admin.png')}}" class="w-75 logo" />
						</a>
						<!--end::Logo-->
						<!--begin::Aside toggler-->
					...
					<div class="scroll-y me-n5 pe-5" data-kt-element="messages" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_drawer_chat_messenger_header, #kt_drawer_chat_messenger_footer" data-kt-scroll-wrappers="#kt_drawer_chat_messenger_body" data-kt-scroll-offset="0px">
						...
						<div class="d-flex justify-content-start mb-10">
							...
							<div class="d-flex flex-column align-items-start">
								...
								<a href="https://www.instagram.com/dimdevs_">Keenthemes.com</a></div>
								<!--end::Text-->
							</div>
							<!--end::Wrapper-->
						</div>
						...
						<div class="mb-0">
							...
							<div class="rounded border border-dashed border-gray-300 py-4 px-6 mb-5">
								<div class="d-flex flex-stack">
									...
									<div class="text-nowrap">
										<a href="https://www.instagram.com/dimdevs_contact/" class="btn btn-sm btn-success" target="_blank">Contact Us</a>
									</div>
								</div>
							</div>
							<!--end::License-->
					...
					<div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_help_body" data-kt-scroll-dependencies="#kt_help_header" data-kt-scroll-offset="5px">
						...
						<div class="rounded border border-dashed border-gray-300 p-6 p-lg-8 mb-10">
							...
							<div class="fs-5 fw-bold mb-5">
								...
								<a class="explore-link d-none" href="https://www.instagram.com/dimdevs_licensing">FAQs</a>
							</div>
							<!--end::Description-->
							<!--begin::Link-->
