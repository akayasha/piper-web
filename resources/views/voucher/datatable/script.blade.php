            ...
            datatable = table.DataTable({
                ...
                'columns': [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            if (data) {
                                return ` <span class="badge badge-success">Sudah Terpakai</span>`;
                            } else {
                                return `<span class="badge badge-secondary">Belum Terpakai</span>`;
                            }
                        },
                        orderable: false
                    },
                        ...
                        render: function(data, type, row) {
                            return `
                                <div class="d-flex justify-content-between">
                                    <a href="/vouchers/detail/${row.id}" class="btn btn-sm btn-primary p-3 m-1">
                                    ...
                                    <a href="/vouchers/edit/${row.id}" class="btn btn-sm btn-success p-3 m-1">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
